...
expedita consequatur consequatur dolores quia eos et placeat`}],Dc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Rc=()=>{const e=Tc.map(t=>{const i=Dc.find(a=>a.id===t.userId),n=Mc.filter(a=>a.postId===t.id);return{...t,user:i,comments:n}});return j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Post and Comments Viewer"}),j.jsx(Lc,{listPosts:e})]})};em(document.getElementById("root")).render(j.jsx(Rc,{}));
